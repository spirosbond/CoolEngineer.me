...
<head>
  <meta charset="utf-8">
  <title>Victoria - Bootstrap vCard Template</title>
  ...
  <div class="col-lg-6 col-lg-offset-3">
    ...
    <div class="row w">
      <div class="col-md-4">
        ...
        <asset:image class="img-responsive" src="Victoria/avatar.jpg" alt=""/>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="contact">
            ...
            <div class="row">
              <div class="col-xs-6">
                <p class="sm">
                  <i class="fa fa-globe"></i> - TemplateMag.com <br/>
                  <i class="fa fa-envelope"></i> - victoria@example.com
                </p>
              </div>
              <!-- col-xs-6 -->
              ...
              <div class="col-xs-6">
                <p class="sm">
                  <i class="fa fa-phone"></i> - +44 2009-4839 <br/>
                  <i class="fa fa-apple"></i> - 902 3940-4439
                </p>
              </div>
              <!-- col-xs-6 -->
            </div>
...
<div class="credits">
  <!--
    ...
    -->
  Created with Victoria template by <a href="https://templatemag.com/">TemplateMag</a>
</div>
