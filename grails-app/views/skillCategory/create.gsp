...
<html>
    ...
    <body>
        <a href="#create-skillCategory" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-skillCategory" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.skillCategory}" method="POST">
                <fieldset class="form">
