...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def testAppUser = new AppUser(name: 'Spiros', url: 'islinked.me', headline: 'The Engineer you want...', aboutMe: 'I like to work work work... I won\'t let you down. Please hire me!', surname: 'Bond', email: 'spirosbond@hotmail.com', dateOfBirth: new Date(), phoneNumber: '+306977766696', address: 'here', user: testUser).save(flush: true)
        def demoAppUser = new AppUser(name: 'John', url: 'islinked.me', headline: 'Electrical & Software Engineer', aboutMe: 'Progressively evolve cross-platform ideas before impactful infomediaries. Energistically visualize tactical initiatives before cross-media catalysts', surname: 'Doe', email: 'jonathan@doe.com', dateOfBirth: new Date('1990/04/21'), phoneNumber: '+1.212.541.8457', address: 'Manhattan, New York', user: demoUser).save(flush: true)

        def testResumeTheme1 = new ResumeTheme(active: false, name: 'One Page Resume', path: '/themes/OnePageResume/index.gsp', defaultPath: '/themes/OnePageResume/default/index.gsp', previewImagePath: '/OnePageResume/onepageresume-preview.png').save(flush: true)
        def testResumeTheme2 = new ResumeTheme(active: false, name: 'Simple Page Resume', path: '/themes/SimplePageResume/index.gsp', defaultPath: '/themes/SimplePageResume/default/index.gsp', previewImagePath: '/SimplePageResume/simplepageresume-preview.png').save(flush: true)
        def testResumeTheme3 = new ResumeTheme(name: 'DIY Resume', path: '/themes/DIYResume/index.gsp', defaultPath: '/themes/DIYResume/default/index.gsp', previewImagePath: '/DIYResume/diyresume-preview.png').save(flush: true)
        def testResumeTheme4 = new ResumeTheme(name: 'Responsive CV', path: '/themes/ResponsiveCV/index.gsp', defaultPath: '/themes/ResponsiveCV/default/index.gsp', previewImagePath: '/ResponsiveCV/responsivecv-preview.png').save(flush: true)
        def testResumeTheme5 = new ResumeTheme(name: 'Responsive Resume', path: '/themes/ResponsiveResume/index.gsp', defaultPath: '/themes/ResponsiveResume/default/index.gsp', previewImagePath: '/ResponsiveResume/responsiveresume-preview.png').save(flush: true)
        def testResumeTheme6 = new ResumeTheme(name: 'Simple Resume', path: '/themes/SimpleResume/index.gsp', defaultPath: '/themes/SimpleResume/default/index.gsp', previewImagePath: '/SimpleResume/simpleresume-preview.png').save(flush: true)
        def testResumeTheme7 = new ResumeTheme(name: 'Responsive Page Resume', path: '/themes/ResponsivePageResume/index.gsp', defaultPath: '/themes/ResponsivePageResume/default/index.gsp', previewImagePath: '/ResponsivePageResume/responsivepageresume-preview.png').save(flush: true)
        def testResumeTheme8 = new ResumeTheme(name: 'Open Source Resume', path: '/themes/OpenSourceResume/index.gsp', defaultPath: '/themes/OpenSourceResume/default/index.gsp', previewImagePath: '/OpenSourceResume/opensourceresume-preview.png').save(flush: true)
        def testResumeTheme9 = new ResumeTheme(name: 'Dev Page Resume', path: '/themes/DevPageResume/index.gsp', defaultPath: '/themes/DevPageResume/default/index.gsp', previewImagePath: '/DevPageResume/devpageresume-preview.png').save(flush: true)
        def testResumeTheme10 = new ResumeTheme(name: 'Victoria Resume', path: '/themes/Victoria/index.gsp', defaultPath: '/themes/Victoria/default/index.gsp', previewImagePath: '/Victoria/victoria-preview.png').save(flush: true)
        def testResumeTheme11 = new ResumeTheme(name: 'Right Resume', path: '/themes/RightResume/index.gsp', defaultPath: '/themes/RightResume/default/index.gsp', previewImagePath: '/RightResume/rightresume-preview.png').save(flush: true)
        def testResumeTheme12 = new ResumeTheme(name: 'Creative Resume', path: '/themes/CreativeResume/index.gsp', defaultPath: '/themes/CreativeResume/default/index.gsp', previewImagePath: '/CreativeResume/creativeresume-preview.png').save(flush: true)
        def testResumeTheme13 = new ResumeTheme(name: 'Kelvin Resume', path: '/themes/KelvinResume/index.gsp', defaultPath: '/themes/KelvinResume/default/index.gsp', previewImagePath: '/KelvinResume/kelvinresume-preview.png').save(flush: true)
